...
export const metadata: Metadata = {
  ...
  description: 'Qué actividades están permitidas y prohibidas en la plataforma WaCommerce.',
}
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-20 sm:px-6">
      ...
      <div className="prose prose-slate mt-10 max-w-none">
        <p>
          Esta política define los usos permitidos y prohibidos de la plataforma WaCommerce. Al usar
