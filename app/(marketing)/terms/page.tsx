...
export const metadata: Metadata = {
  ...
  description: 'Términos y condiciones de uso de la plataforma WaCommerce.',
}
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-20 sm:px-6">
      ...
      <div className="prose prose-slate mt-10 max-w-none">
        ...
        <p>
          Al acceder o usar la plataforma WaCommerce (el &ldquo;Servicio&rdquo;), aceptas estar vinculado a estos
        ...
        <p>
          WaCommerce es una plataforma SaaS que permite a comerciantes crear catálogos y menús
        ...
        <p>
          WaCommerce no será responsable por pérdidas indirectas, incidentales o consecuentes
