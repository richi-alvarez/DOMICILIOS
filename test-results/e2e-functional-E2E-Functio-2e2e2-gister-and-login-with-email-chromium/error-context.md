...
- Name: e2e-functional.spec.ts >> E2E Functional Tests - Full User Flow >> 1. User can register and login with email
- Location: tests/e2e-functional.spec.ts:11:7
...
Expected pattern: /signup|login|registro/i
Received string:  ""
Timeout: 5000ms
