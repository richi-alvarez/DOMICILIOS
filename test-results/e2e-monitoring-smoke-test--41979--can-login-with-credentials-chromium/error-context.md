...
- Name: e2e/monitoring-smoke-test.spec.ts >> Monitoring Dashboard - Smoke Test >> Free user can login with credentials
- Location: tests/e2e/monitoring-smoke-test.spec.ts:15:7
