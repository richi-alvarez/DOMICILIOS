...
- Name: e2e/monitoring-smoke-test.spec.ts >> Monitoring Dashboard - Smoke Test >> Pro user can login with credentials
- Location: tests/e2e/monitoring-smoke-test.spec.ts:28:7
