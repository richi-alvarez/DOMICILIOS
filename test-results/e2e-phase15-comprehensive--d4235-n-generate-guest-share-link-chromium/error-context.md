...
- Name: e2e/phase15-comprehensive.spec.ts >> Phase 15 - Advanced Reports Features E2E >> User: Juan Rodríguez (Premium) >> 11. User can generate guest share link
- Location: tests/e2e/phase15-comprehensive.spec.ts:324:11
...
Call log:
    - checking visibility of locator('button[aria-label*="share"], button:has-text("Compartir"):first')
