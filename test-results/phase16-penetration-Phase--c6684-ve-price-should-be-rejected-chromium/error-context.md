...
- Name: phase16-penetration.spec.ts >> Phase 16 - Penetration Testing >> 2.4 Data Integrity Checks >> Create order with negative price should be rejected
- Location: tests/phase16-penetration.spec.ts:86:9
