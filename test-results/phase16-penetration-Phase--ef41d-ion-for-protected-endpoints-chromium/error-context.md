...
- Name: phase16-penetration.spec.ts >> Phase 16 - Penetration Testing >> 2.3 Authorization Level Verification >> API should require authentication for protected endpoints
- Location: tests/phase16-penetration.spec.ts:69:9
